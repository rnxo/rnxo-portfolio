  ...
  return (
    <main className="page-wrap px-4 py-12">
      ...
      <FlipCard
          ...
          <div className="island-shell rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col items-center gap-6 lg:flex-row lg:items-start lg:gap-8">
              ...
              <div className="w-full text-center lg:text-left">
                ...
                <h1 className="text-lagoon-deep font-bit mb-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
        ...
        back={
          <div className="island-shell rounded-2xl p-6 sm:p-8">
            <h2 className="font-mechanic text-lagoon-deep my-5 text-center text-3xl">
              <ScrambleText text="SKILLS" speed={60} />
            </h2>
            <div className="flex flex-col gap-10 min-[375px]:grid min-[375px]:grid-cols-3 lg:grid-cols-5">
              {skills.map((skill) => (
                <div
                  key={skill}
                ...
                >
                  ...
                  <span className="font-mechanic text-center">{skill}</span>
                </div>
              ))}
            </div>
            <h2 className="font-mechanic text-lagoon-deep my-5 text-center text-3xl">
            ...
            <div className="flex flex-col gap-10 min-[375px]:grid min-[375px]:grid-cols-3 lg:grid-cols-5">
              {challengeSkills.map((cs) => (
                ...
                >
                  ...
                  <span className="font-mechanic text-center">{cs}</span>
                </div>
              ))}
            </div>
      ...
      <section className="flex flex-col items-center justify-center">
        <h2 className="font-mechanic text-lagoon-deep my-5 text-3xl">
